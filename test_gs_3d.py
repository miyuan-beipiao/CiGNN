...
if __name__ == '__main__':
    ...
    dataset = 'gs'
    dimension = 3
    test_seed_list = np.linspace(60, 60, 1, dtype=int)
    main(dataset, dimension, test_seed_list)
    # plot_full_dataset(dataset, dimension, test_seed_list)
    ...
    """ 
        ...
        """
    # print('绘制 figure')
    # for _, train_item in enumerate(train_seed_list):
    #     imageUtils.plot_all_data(train_item,args)
