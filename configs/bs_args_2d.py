...
def get_config_bs(dataset='bs'):
    ...
    parser.add_argument('--addition-feature-dim', type=int, default=3, help='addition input feature dimension.')
    ...
    parser.add_argument('--pool-layer', type=int, default=2, help='pool layers.')
    ...
    parser.add_argument('--roll-step', type=int, default=20, help='roll time steps.')
    ...
    parser.add_argument('--all-time-steps', type=int, default=10408, help='All time steps. ')
    parser.add_argument('--mesh-node', type=int, default=5000, help='mesh nodes.')
