...
def get_config_gs(dataset='gs'):
    ...
    parser.add_argument('--feature-dim', type=int, default=2, help='input feature dimension.')
    parser.add_argument('--num-classes', type=int, default=2, help='output feature dimension.')
    ...
    # parser.add_argument('--hidden-dim', type=int, default=64, help='hidden units.')
    # parser.add_argument('--hidden-layer', type=int, default=4, help='hidden layers.')
    ...
    parser.add_argument('--weight-decay', type=float, default=1e-8, help='Weight decay ~ L2 loss.')
    # parser.add_argument('--weight-decay', type=float, default=1e-8, help='Weight decay ~ L2 loss.')
    ...
    parser.add_argument('--roll-step', type=int, default=1, help='roll time steps.')
    ...
    parser.add_argument('--all-time-steps', type=int, default=3001, help='All time steps.')
    parser.add_argument('--mesh-node', type=int, default=13824, help='mesh nodes.110592/13824')
    ...
    parser.add_argument('--DA', type=float, default=0.2, help='DA Diffusion coefficients.')
    parser.add_argument('--DB', type=float, default=0.1, help='DB Diffusion coefficients.')
    parser.add_argument('--f', type=float, default=0.025, help='birth/death rates.')
    parser.add_argument('--k', type=float, default=0.055, help='birth/death rates.')
    # parser.add_argument('--dt', type=float, default=0.25, help='delta t.')
    # parser.add_argument('--dx', type=float, default=1.0, help='delta x.')
    # parser.add_argument('--dy', type=float, default=1.0, help='delta y.')
    # parser.add_argument('--dz', type=float, default=1.0, help='delta z.')
    # parser.add_argument('--width', type=int, default=10, help='width.')
    # parser.add_argument('--height', type=int, default=10, help='height.')
    # parser.add_argument('--length', type=int, default=10, help='length.')

    parser.add_argument('--dt', type=float, default=0.5, help='delta t.')
    parser.add_argument('--dx', type=float, default=2.0, help='delta x.')
    parser.add_argument('--dy', type=float, default=2.0, help='delta y.')
    parser.add_argument('--dz', type=float, default=2.0, help='delta z.')
    parser.add_argument('--width', type=int, default=24, help='width.')
    parser.add_argument('--height', type=int, default=24, help='height.')
    parser.add_argument('--length', type=int, default=24, help='length.')
    parser.add_argument('--pad-len', type=int, default=1, help='padding length.')
    parser.add_argument('--seed', type=int, default=44, help='Random seed.')
    parser.add_argument('--best-valid-loss', type=int, default=1, help='best valid loss')
    parser.add_argument('--pos-feature-dim', type=int, default=3, help='pos feature dimension.')
