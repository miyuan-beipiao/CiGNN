...
def get_config_burgers(dataset='burgers'):
    ...
    parser.add_argument('--mesh-node', type=int, default=2500, help='mesh nodes.')
    ...
    parser.add_argument('--viscocity', type=float, default=0.01, help='viscocity.')
    ...
    parser.add_argument('--width', type=int, default=50, help='width.')
