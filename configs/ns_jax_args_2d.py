...
def get_config_ns(dataset='ns'):
    ...
    parser.add_argument('--addition-feature-dim', type=int, default=1, help='addition input feature dimension.')
    ...
    parser.add_argument('--feature-dim', type=int, default=1, help='input feature dimension.')
    parser.add_argument('--num-classes', type=int, default=1, help='output feature dimension.')
    ...
    parser.add_argument('--pool-layer', type=int, default=0, help='pool layers.')
    ...
    parser.add_argument('--weight-decay', type=float, default=0, help='Weight decay ~ L2 loss.')
    ...
    parser.add_argument('--all-time-steps', type=int, default=600, help='All time steps.')
    parser.add_argument('--mesh-node', type=int, default=4096, help='mesh nodes.')
    ...
    parser.add_argument('--viscocity', type=float, default=0.001, help='viscocity.')
    parser.add_argument('--dt', type=float, default=0.1, help='delta t.')
    parser.add_argument('--dx', type=float, default=0.02, help='delta x.')
    parser.add_argument('--dy', type=float, default=0.02, help='delta y.')
    ...
    parser.add_argument('--data-save-path', type=str, default='/mnt/miyuan/AI4Physics/Data/{}/'.format(dataset),
                        help='data save path.')
    parser.add_argument('--gif-save-name', type=str, default='{}_phy'.format(dataset), help='gif save name.')
